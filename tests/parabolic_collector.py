...
cylinder_out.Placement = FreeCAD.Placement(Base.Vector(0.0,0.0,647.0),FreeCAD.Rotation(Base.Vector(1,0.0,0.0),-90.0))
...
cylinder_in.Placement = FreeCAD.Placement(Base.Vector(0.0,0.0-1.0,647.0),FreeCAD.Rotation(Base.Vector(1.0,0.0,0.0),-90.0))
